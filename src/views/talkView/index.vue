    ...
    chatLog.value = [
      {
        id: Date.now(),
        role: "bot",
        text: "猫眼石，‘你比拉古那的雨夜更准时。’……坐过来些，这里的视角最好。",
      },
    ];
...
$accent-1: #bff7ff; // 暗紫主光（冷雅）
$accent-2: #ff66c4; // 冷海蓝高光（湿光感）

$accent-2-light: #f5fafc; // $accent-2 向白方向提亮约12%（手算替代 rgba）
...
.chat-page {
  ...
  .message {
    ...
    .avatar {
      ...
      &.bot {
        background-image: url("@/assets/avatar/kelaita.webp");
